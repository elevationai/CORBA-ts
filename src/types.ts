...
export namespace CORBA {
  ...
  // Special types
  export type TypeCode = any; // Will be defined fully later
  ...
  export interface ObjectRef {
    ...
    [key: string]: any; // Allow any other method
  }
  ...
  export class SystemException extends Error {
    ...
    constructor(message: string, minor: number | string = 0, completed: CompletionStatus = CompletionStatus.COMPLETED_NO) {
      super(message);
  ...
  export class UNKNOWN extends SystemException {
    constructor(minor: number | string = 0, completed: CompletionStatus = CompletionStatus.COMPLETED_NO) {
  ...
  export class BAD_PARAM extends SystemException {
    constructor(minor: number | string = 0, completed: CompletionStatus = CompletionStatus.COMPLETED_NO) {
      super(typeof minor === "string" ? `CORBA.BAD_PARAM: ${minor}` : "CORBA.BAD_PARAM", minor, completed);
  ...
  export class NO_MEMORY extends SystemException {
    constructor(minor: number | string = 0, completed: CompletionStatus = CompletionStatus.COMPLETED_NO) {
      super(typeof minor === "string" ? `CORBA.NO_MEMORY: ${minor}` : "CORBA.NO_MEMORY", minor, completed);
  ...
  export class INV_OBJREF extends SystemException {
    constructor(minor: number | string = 0, completed: CompletionStatus = CompletionStatus.COMPLETED_NO) {
      super(typeof minor === "string" ? `CORBA.INV_OBJREF: ${minor}` : "CORBA.INV_OBJREF", minor, completed);
  ...
  export class COMM_FAILURE extends SystemException {
    constructor(minor: number | string = 0, completed: CompletionStatus = CompletionStatus.COMPLETED_NO) {
      super(typeof minor === "string" ? `CORBA.COMM_FAILURE: ${minor}` : "CORBA.COMM_FAILURE", minor, completed);
  ...
  export class MARSHAL extends SystemException {
    constructor(minor: number | string = 0, completed: CompletionStatus = CompletionStatus.COMPLETED_NO) {
      super(typeof minor === "string" ? `CORBA.MARSHAL: ${minor}` : "CORBA.MARSHAL", minor, completed);
  ...
  export class NO_IMPLEMENT extends SystemException {
    constructor(minor: number | string = 0, completed: CompletionStatus = CompletionStatus.COMPLETED_NO) {
      super(typeof minor === "string" ? `CORBA.NO_IMPLEMENT: ${minor}` : "CORBA.NO_IMPLEMENT", minor, completed);
  ...
  export class INTERNAL extends SystemException {
    constructor(minor: number | string = 0, completed: CompletionStatus = CompletionStatus.COMPLETED_NO) {
      super(typeof minor === "string" ? `CORBA.INTERNAL: ${minor}` : "CORBA.INTERNAL", minor, completed);
